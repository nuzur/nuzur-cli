...
func (i *Implementation) DeployCommand() cli.Command {
	return cli.Command{
		...
		Flags: []cli.Flag{
			...
			cli.StringFlag{Name: "s3-endpoint", Usage: "Endpoint for an S3-compatible store (e.g. Cloudflare R2: https://<account-id>.r2.cloudflarestorage.com). Used with the manual --s3-* flags; leave unset for AWS S3."},
